...
/** SSR-sicherer Mobile-Breakpoint (< sm): entscheidet Dialog vs. Bottom-Sheet
 *  (Mock: Desktop-Modal / Mobile-Refresh-Sheet). Server snapshot = false →
 *  Dialog, korrigiert sich nach Hydration. */
