...
// (p, a, ul/ol/li, h3/h4, code, pre, blockquote, hr, strong/em, span.mention).
// .mention = @-Erwähnung (Brand-Pill, gleiche Token wie assign-button).
export const PROSE_CLASS =
  ...
  '[&_.mention]:rounded [&_.mention]:bg-brand-50 [&_.mention]:px-1 [&_.mention]:py-px [&_.mention]:font-medium [&_.mention]:text-brand';
