...
describe('ELIGIBILITY_EXCLUDE_TYPE_UIDS', () => {
  ...
  // knowledge worth pinning: 3 = Beitrag in Magazin/Zeitung,
  // 5 = Rezension, 7 = Diplomarbeit, 8 = Dissertation, 13 = Habilitation,
  // 15 = Konferenz-Poster, 19 = Skriptum, 23 = Lexikon-Stub.
  it('is the canonical [3, 5, 7, 8, 13, 15, 19, 23]', () => {
    expect(ELIGIBILITY_EXCLUDE_TYPE_UIDS).toEqual([3, 5, 7, 8, 13, 15, 19, 23]);
  });
});
