...
export function CapybaraLogo({ size = 'md', className }: CapybaraLogoProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx="95" cy="82" r="12" stroke={BRAND_HEX} strokeWidth="3" fill="white" fillOpacity="0.3" />
      <circle cx="95" cy="82" r="9" stroke={BRAND_HEX} strokeWidth="1.5" fill="white" fillOpacity="0.15" />
      <line x1="104" y1="91" x2="112" y2="102" stroke={BRAND_HEX} strokeWidth="4" strokeLinecap="round" />
